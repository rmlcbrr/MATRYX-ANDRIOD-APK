...
$(document).ready(function(){
   ...
   $(document).on('click', '.toggleButtonMC', function() {
...
$(document).on('click', '.toggleButtonCAR', function() {
    let currentValue = $(this).attr('data-value');
    let newValue;
    let newIcon;
   ...
   $(document).on('click', '#mc-save', function() {
        let results = {};
        document.querySelectorAll('.toggleButtonMC').forEach(button => {
   ...
   $(document).on('click', '#car-save', function() {
        let results = {};
        document.querySelectorAll('.toggleButtonCAR').forEach(button => {
        let item = button.parentElement.textContent.trim().slice(1);  // Remove the icon and space
        let value = button.getAttribute('data-value');
            if(value == -1 || value == 1){
                results[item] = value;
